...
module "checks" {
  source      = "git::https://github.com/amilochau/tf-modules.git//shared/checks?ref=amilochau/improve-iam"
  conventions = var.conventions
}

module "functions_app" {
  source      = "git::https://github.com/amilochau/tf-modules.git//aws/functions-app?ref=amilochau/improve-iam"
  conventions = var.conventions
...
module "client_app" {
  source      = "git::https://github.com/amilochau/tf-modules.git//aws/static-web-app?ref=amilochau/improve-iam"
  conventions = var.conventions
